...
public class GrappleLevelOne extends GrappleItem{

    public GrappleLevelOne(ItemsCustom plugin) {
        super("grapple_level_one", ChatColor.GREEN + "Grappin de niveau 1", null, Material.FISHING_ROD, 1, 20L, plugin);
    }
    ...
    public void onFish(PlayerFishEvent e) {
        ...
        player.setVelocity(change.toVector().multiply(0.21));
